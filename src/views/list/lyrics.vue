    ...
    <div class="lyrics-page">
        ...
        <div class="controls">
            ...
            <div class="progress-bar">
                ...
                <div class="slider">
                    <VueSlider v-model="progress" :min="0" :max="playStore.time" :interval="1" :drag-on-click="true"
                        :duration="0" :dot-size="12" :height="2" :tooltip-formatter="FormatTrackTime" :silent="true">
                    </VueSlider>
                </div>
